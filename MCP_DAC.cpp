...
//   if (channel == 1) // Channel 0 or 1    1001 0000 0000 0000
//     data |= 0x8000;
//   if (_buffered) // ?  	0101 0000 0000 0000
//     data |= 0x4000;
//   if (_gain == 1) // Gain 0 x2, 1 x1 1100 00 0000 0000
//     data |= 0x2000;
...
void MCP_DAC::transfer(uint16_t data)
{
  ...
  if (_hwSPI)
  {
    ...
    mySPI->transfer((uint8_t)(data >> 16)); // ET third byte for MCP48FVB21
